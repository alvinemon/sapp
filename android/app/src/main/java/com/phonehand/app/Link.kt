...
internal object Link {
    ...
    fun phoneWsUrl(host: String, deviceId: String, secret: String, name: String, model: String): String {
        ...
        return "wss://$host/ws?role=phone&device=$encDevice&secret=$encSecret&name=$encName&model=$encModel"
    }
